...
export default {
  ...
  "organizationName": "BuildMotion",
  "projectName": "angular-clean-architecture-workshop",
  "i18n": {
    "defaultLocale": "en",
    "locales": [
      "en"
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "/Users/valencia/work/github/angular-whats-new-what-matters/docs/sidebars.js",
        ...
        "theme": {
          "customCss": "/Users/valencia/work/github/angular-whats-new-what-matters/docs/src/css/custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2022 Build Motion, LLC. Built by Matt Vaughn."
    },
    "prism": {
      "theme": {
        "plain": {
